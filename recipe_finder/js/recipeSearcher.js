class RecipeSearcher {
    static getRecipes(ingredients) {
        const URL = "https://www.food2fork.com/api/search" + "?key=" + API_KEY + "&q=" + ingredients
        console.log(URL);
        fetch(URL).then(data => {
            console.log(data);
            return data.json();
        })
        .then(res=> { RecipeSearcher.formResultPage(res)})
    };
...
module.exports = {RecipeSearcher: RecipeSearcher};